...
import {
  ...
  Building, FileText, Settings, Save
} from 'lucide-react';
...
const ListRooms = () => {
  ...
  const [newOccupancyType, setNewOccupancyType] = useState('');
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-[#2B2B40] rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('shared_with', parseInt(e.target.value) || '')}
                      className="w-full p-3 rounded-lg bg-[#1E1E2F] border border-gray-600 focus:border-[#00C49A] focus:outline-none"
                      placeholder="e.g., 2"
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('current_occupants', parseInt(e.target.value) || '')}
                      className="w-full p-3 rounded-lg bg-[#1E1E2F] border border-gray-600 focus:border-[#00C49A] focus:outline-none"
                      placeholder="e.g., 1"
                      required
                    />
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Allowed Occupant Types</label>
                  <div className="flex gap-2 mb-2">
                    <select
                      value={newOccupancyType}
                      onChange={(e) => setNewOccupancyType(e.target.value)}
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (newOccupancyType) {
                          addToArray('occupancy.allowed', newOccupancyType);
                          setNewOccupancyType('');
                        }
                      }}
                      className="px-4 py-3 bg-[#00C49A] hover:bg-[#00b388] rounded-lg flex items-center gap-2"
                    >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {formData.occupancy.allowed.map((type, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center gap-1 bg-[#00C49A] px-3 py-1 rounded-full text-sm"
                      >
                        {type}
                        <button
                          type="button"
                          onClick={() => {
                            const newAllowed = formData.occupancy.allowed.filter((_, i) => i !== index);
                            setFormData(prev => ({
                              ...prev,
                              occupancy: {
                                ...prev.occupancy,
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mb-2">
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg flex items-center gap-2"
                      >
                        <Plus className="w-4 h-4" />
                      </button>
                    </div>
                    <div className="space-y-2">
                      {formData.restrictions.map((restriction, index) => (
                        <div key={index} className="flex items-center justify-between p-2 bg-purple-600/20 rounded">
                          ...
                          <button
                            type="button"
                            onClick={() => removeFromArray('restrictions', index)}
                            className="text-red-400 hover:text-red-300"
                          >
                            <X className="w-4 h-4" />
                          </button>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('monthly_rent', parseInt(e.target.value) || '')}
                      className="w-full p-3 rounded-lg bg-[#1E1E2F] border border-gray-600 focus:border-[#00C49A] focus:outline-none"
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-4 h-4 text-[#00C49A] bg-[#1E1E2F] border-gray-600 rounded focus:ring-[#00C49A]"
                    />
                    <label htmlFor="available" className="text-sm">Available immediately</label>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2B2B40] rounded-lg p-6">
                ...
                <div className="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center">
                  ...
                  <p className="text-sm text-gray-400 mb-2">Click to upload images</p>
              ...
              <button
                ...
                className="w-full bg-purple-600 hover:bg-purple-800 text-white py-4 rounded-lg font-semibold flex items-center justify-center gap-2 text-lg"
              >
