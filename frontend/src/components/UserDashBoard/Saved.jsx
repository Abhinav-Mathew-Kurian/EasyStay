...
const Saved = () => {
  ...
  const handleRemoveSaved = (roomId) => {
  ...
  useEffect(() => {
    // For demo purposes, let's show multiple saved rooms
    setSavedRooms(DemoListing);
  }, []);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {savedRooms.map((room) => (
            <div
              ...
              className="
                group relative
               bg-gradient-to-br from-[#1E1E2F]/90 to-[#1E1E2F]/70 backdrop-blur-lg
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Rating */}
                {getStars(room.reviews.rating, room.reviews.count)}
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button
                    ...
                    className="
                      flex-1 bg-gradient-to-r from-emerald-500/20 to-teal-500/20
